...
// //     <header
// //       ref={headerRef}
// //       className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-sm py-1" : "bg-white py-2"}`}
// //     >
...
// //                 <div
// //                   key={index}
// //                   className={`absolute flex justify-center items-center w-full transition-all duration-700 transform ${index === announcementIndex ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-full"}`}
// //                 >
...
// //                 <p className="text-[9px] text-gray-500 tracking-wider transition-opacity duration-300">EST. 2025</p>
...
// //             <button className="absolute top-4 right-4 text-gray-400 hover:text-gray-800 transition-all duration-300" onClick={toggleAuthModal}>
// //               <X size={24} />
// //             </button>
// //             <h2 className="text-2xl font-light text-gray-900 mb-6">{isLoginForm ? content[language].login : content[language].register}</h2>
...
// //               </div>
// //               <div>
// //                 <label className="block text-sm text-gray-600 mb-2">{language === "vi" ? "Mật khẩu" : "Password"}</label>
// //                 <input
// //                   type="password"
// //                   name="password"
...
// //               {!isLoginForm && (
// //                 <div>
// //                   <label className="block text-sm text-gray-600 mb-2">{language === "vi" ? "Xác nhận mật khẩu" : "Confirm Password"}</label>
// //                   <input
// //                     type="password"
...
// //                 </div>
// //               )}
// //               <button type="submit" className="w-full bg-black text-white py-2 rounded-md hover:bg-gray-800 transition-colors duration-300">
...
// //               <button className="text-gray-900 hover:text-black underline ml-1" onClick={switchForm}>
...
// //                 <span className="font-light text-xl tracking-widest text-gray-900 font-[Cinzel,serif]">WEATHERED</span>
// //               </Link>
// //               <button
...
// //                           </button>
// //                           <div
// //                             className={`mt-3 pl-4 space-y-3 overflow-hidden transition-all duration-500 ${visibleSubmenu === index ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}
// //                           >
// //                             {item.submenu.map((subItem, subIndex) => (
// //                               <Link
// //                                 key={subIndex}
...
// //                   <span className="text-base">{language === "vi" ? "Tiếng Việt" : "English"}</span>
// //                 </button>
// //               </div>
// //               <div className="space-y-4 text-sm text-gray-600">
// //                 <h3 className="text-gray-800 font-medium text-sm tracking-wider mb-4">{content[language].contact}</h3>
...
// //               </div>
// //               <div className="mt-10">
// //                 <h3 className="text-gray-800 font-medium text-sm tracking-wider mb-4">{content[language].followUs}</h3>
...
// //               </div>
// //             </div>
// //             <div className="mt-auto px-6 py-4 border-t border-gray-100 text-xs text-gray-500">© 2025 WEATHERED. All rights reserved.</div>
// //           </div>
// //         </div>
// //       )}
...
//                     placeholder={content[language].searchPlaceholder}
//                     className="w-full border-0 text-black border-b border-gray-200 py-3 pl-8 pr-16 text-base focus:outline-none focus:border-gray-800 bg-transparent transition-colors duration-300 placeholder:text-gray-400 placeholder:font-light"
//                     autoFocus
//                   />
//                   <button
...
//                       onKeyDown={handleSearchKeyDown}
//                       placeholder={content[language].mobileSearchPlaceholder}
//                       className="w-full border-0 border-b border-gray-200 py-3 pl-8 pr-16 text-base focus:outline-none transition-colors duration-300 bg-transparent placeholder:text-gray-400 placeholder:font-light"
//                     />
//                     <button
//                       onClick={handleSearch}
//                       className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-800 transition-all duration-300"
